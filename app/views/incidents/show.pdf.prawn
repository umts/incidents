...
prawn_document do |pdf|
  ...
  pdf.field_row height: 30, units: 6 do
  ...
  pdf.field_row height: 20, units: 4 do
  ...
  pdf.field_row height: 30, units: 112 do
  ...
  pdf.field_row height: 20, units: 28 do
  ...
  pdf.field_row height: 72, units: 22 do
